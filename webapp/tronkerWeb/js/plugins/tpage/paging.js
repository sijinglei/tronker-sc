    ...
    Paging.prototype = {
        init: function(settings) {
            this.settings = $.extend({
                ...
                // firstTpl: "<<",
                // lastTpl: ">>",
                prevTpl: "<i class='glyphicon glyphicon-chevron-left'></i>",
                nextTpl: "<i class='glyphicon glyphicon-chevron-right'></i>",
                firstTpl: "<i class='glyphicon glyphicon-step-backward'></i>",
                lastTpl: "<i class='glyphicon glyphicon-step-forward'></i>",
                ellipseTpl: "...",
                toolbar: false,
                goto: true,
                hash: true,
        ...
        format: function() {
            ...
            html += '<li class="ui-paging-count" >查询出' + this.count + '条数据，</li>';
        ...
        bindToolbar: function() {
            var _this = this;
            var html = $('<li class="ui-paging-toolbar">每页<select class="ui-select-pagesize"></select>条</li>');
            ...
            this.container.children('ul').find('li:first').after(html);
        },
        bindGoto: function() {
            var _this = this;
            // var html = $('<li class="ui-paging-goto"><div class="input-group">到<input type="text" class="form-control"> <span class="input-group-addon">GO</span></div></li>');
            var html = $('<li class="ui-paging-goto">到<input type="text" class="ui-paging-count"/><a href="javascript:void(0)">GO</a>页</li>');
